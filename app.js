...
io.on("connection",function(socket)
{
    ...
    socket.emit("notify",{'message':"Welcome to car parking service"});
...
app.get('/',function(req,res){
    res.send("<marquee>car parking is online</marquee>");
});
app.get('/high',function(req,res){
    console.log("high");
    io.to("room01-ehealth").emit('notify',{'message':"Alert:parking at 1"});
    res.send("done");
});

app.get('/Alert',function(req,res){
    console.log("Manual Alert received");
    io.to("room01-ehealth").emit('alert_m',{'message':"parking is full"});
    res.send("done");
});
...
app.get('/low',function(req,res){
    console.log("low");
    io.to("room01-ehealth").emit('notify',{'message':"Alert: parking at 2"});
    res.send("done");
});
